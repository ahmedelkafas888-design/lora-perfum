...
// سعر الصرف الثابت المعتمد للموقع
const EXCHANGE_RATE = 50.00; 

// الكتالوج الافتراضي للموقع في حال عدم وجود منتجات مخزنة
...
// تهيئة قاعدة البيانات المحلية للموقع عند أول تشغيل
function initApp() {
...
// حساب السعر النهائي بالجنيه المصري بعد الخصم
...
// بناء بطاقة المنتج المتناسقة (عنصر رئيسي لشبكة العرض الثنائية)
